$(document).ready(function() {
    ...
    function calc() {
        ...
        // $('#calcResult').html('<div><div>Затраты на бензин</div><div class="resultDiv">' + gap(zbenz, ' ') + ' рублей</div><div style="margin-top: 16px;">Затраты на газ</div><div class="resultDiv">' + gap(zgaz, ' ') + ' рублей</div><div style="margin-top: 16px;">Экономия</div><div class="resultDiv">' + gap(ekonom, ' ') + ' рублей</div></div>');
        $("#zbenz").val(gap(zbenz, ' '));
        $("#zgaz").val(gap(zgaz, ' '));
